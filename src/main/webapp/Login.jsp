    ...
    <div id="con">
        <div id="login">
            <div id="login_form">
                <!--로그인 폼-->
                <form>
                    <h3 class="login" style="letter-spacing:-1px;">여기에 로고 박아버리기?</h3>

                    <hr>
                    <label>
			<!-- ID -->
			<p style="text-align: left; font-size:12px; color:#666">ID</p>
			<input type="text" placeholder="아이디를 입력하세요" class="size"style="width: 420px;">
			...
			<input type="password" placeholder="비밀번호를 입력하세요" class="size"style="width: 420px;">
			<!-- <input type="submit" value="확인"> -->
			</label>
