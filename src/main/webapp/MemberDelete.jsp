...
<body class="animsition">
    ...
    <!-- 상단 -->
    <section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(images/전통차.png);">
    ...
    <div id="con">
        <div id="login">
            <div id="bye_form">
                <form>
                    ...
                    <label>
						<!--현재 비밀번호-->
					  <p style="text-align: center; font-size:12px; color:#666">탈퇴사유 </p>
					  <input type="text" placeholder="탈퇴사유를 적어주세요" class="size" style="width:400px">
					  </label>
		...
		<input type="password" placeholder="비밀번호 입력" class="size" style="width:400px">
                    ...
                    <!--회원탈퇴 버튼-->
                    <p>
                        <a href="회원가입수정.html" type="submit" class="btn">회원탈퇴</a>
                    </p>
                </form>
                <p class="find">
