    ...
    <section>
        ...
        <div class="container">
            <div class="row">
				...
				<%if (info != null) {%>
				<h3 style="text-align:right;"><a href="BoardWrite.jsp" style="align:right; font-family:Montserrat; font-size:25px; font-weight:bold;">
                        ...
                        <div class="blo4 p-b-63">
                            ...
                            <div class="text-blo4 p-t-33">
                                ...
                                <div class="txt32 flex-w p-b-24">
                                    <span>
										작성자 : <%=board_list.get(i).getWriter() %>
										<span class="m-r-6 m-l-4">|</span>
                                    </span>

                                    <span>
										작성 일시 :<%=board_list.get(i).getB_date().toString() %>
										<span class="m-r-6 m-l-4">|</span>
                                    </span>
                                </div>
