...
>>>>>>> branch 'master' of https://github.com/2022-SMHRD-KDT-BIgData-14/pythonchip.git
					...
					<div class="wrap_menu p-l-45 p-l-0-xl">
						<nav class="menu">
							<ul class="main_menu">
								...
								<li><a href="menu.html">map search</a></li>

								<li><a href="gallery.html">store</a></li>

								<li><a href="blog.html">comunity</a></li>



								<li><a href="storejoin.html">가게등록</a></li>
					...
					<!-- Social -->
					<div class="social flex-w flex-l-m p-r-20">
						<li><a href="contact.html" style="padding-right: 20px;">
								login </a></li>
						<li><a href="join.html" style="padding-left: 20px;"> join
						</a></li>
	...
	<aside class="sidebar trans-0-4">
		...
		<div class="gallery-sidebar t-center p-l-60 p-r-60 p-b-40">
			...
			<ul class="menu-sidebar p-t-95 p-b-70">
				<li class="t-center m-b-13"><a href="index.html" class="txt19">로고</a>
				</li>
				<ul class="menu-sidebar p-t-95 p-b-70">


					<li class="t-center m-b-13"><a href="menu.html" class="txt19">map
							search</a></li>



					<li class="t-center m-b-13"><a href="gallery.html"
						class="txt19">store</a></li>

					<li class="t-center m-b-13"><a href="blog.html" class="txt19">comunity</a>
					</li>

					<li class="t-center m-b-13"><a href="mypage.html"
						class="txt19">my page</a></li>


					<li class="t-center m-b-13"><a href="storejoin.html"
						class="txt19">storejoin</a></li>

					<li class="t-center">
						<!-- 슬라이드바 로그인 --> <a href="contact.html"
			...
			<div class="row">
				<div class="col-md-8 col-lg-9">
					<div class="p-t-80 p-b-124 bo5-r h-full p-r-50 p-r-0-md bo-none-md">
						...
						<div class="blo4 p-b-63">
							<div class="pic-blo4 hov-img-zoom bo-rad-10 pos-relative">
								<a href="blog-detail.html"> <img src="images/blog-06.jpg"
									alt="IMG-BLOG">
								</a>

								<div class="date-blo4 flex-col-c-m">
									<span class="txt30 m-b-4"> 20 </span> <span class="txt31">
										Dec, 2018 </span>
								</div>
							</div>
							...
							<div class="text-blo4 p-t-33">
								<h4 class="p-b-16">
									<a href="blog-detail.html" class="tit9">Pizza is prepared
										fresh</a>
								</h4>

								<div class="txt32 flex-w p-b-24">
									<span> by <%= board_list.get(0).getWriter()%> 
										<span class="m-r-6 m-l-4">|</span>
									</span> <span>  <%= board_list.get(0).getB_date().toString()%>
										<span class="m-r-6 m-l-4">|</span>  </span> 
										<span> Cooking, Food <span class="m-r-6 m-l-4">|</span> -->
								...
								<a href="blog-detail.html" class="dis-block txt4 m-t-30">
									Continue Reading <i class="fa fa-long-arrow-right m-l-10"
									aria-hidden="true"></i>
								</a>
							</div>
						</div>
				...
				<div class="col-md-4 col-lg-3">
					<div class="sidebar2 p-t-80 p-b-80 p-l-20 p-l-0-md p-t-0-md">
						...
						<div class="popular">
							...
							<ul>
								<li class="flex-w m-b-25">
									...
									<div class="size28">
										<a href="#" class="dis-block txt28 m-b-8"> Best Places for
											Wine </a> <span class="txt14"> 3 days ago </span>
									</div>
								</li>
								...
								<li class="flex-w m-b-25">
									...
									<div class="size28">
										<a href="#" class="dis-block txt28 m-b-8"> Eggs and Cheese
										</a> <span class="txt14"> July 2, 2017 </span>
									</div>
								</li>
						...
						<div class="archive">
							...
							<ul>
								<li class="flex-sb-m p-t-8 p-b-8"><a href="#" class="txt27">
										uly 2018 </a> <span class="txt29"> (9) </span></li>

								<li class="flex-sb-m p-t-8 p-b-8"><a href="#" class="txt27">
										June 2018 </a> <span class="txt29"> (39) </span></li>

								<li class="flex-sb-m p-t-8 p-b-8"><a href="#" class="txt27">
										May 2018 </a> <span class="txt29"> (29) </span></li>

								<li class="flex-sb-m p-t-8 p-b-8"><a href="#" class="txt27">
										April 2018 </a> <span class="txt29"> (35) </span></li>

								<li class="flex-sb-m p-t-8 p-b-8"><a href="#" class="txt27">
										March 2018 </a> <span class="txt29"> (22) </span></li>

								<li class="flex-sb-m p-t-8 p-b-8"><a href="#" class="txt27">
										February 2018 </a> <span class="txt29"> (32) </span></li>

								<li class="flex-sb-m p-t-8 p-b-8"><a href="#" class="txt27">
										January 2018 </a> <span class="txt29"> (21) </span></li>

								<li class="flex-sb-m p-t-8 p-b-8"><a href="#" class="txt27">
										December 2017 </a> <span class="txt29"> (26) </span></li>
							</ul>
						</div>
					</div>
				</div>
